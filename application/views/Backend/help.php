				...
				<div class="col-sm-16 col-sm-offset-1">
					...
					<div class="jumbotron">
						...
						"
							...
							3.填写课程名称，例如数据结构.<br>
							4.填写辅导员名称.<br>
							以上均为必填项，如果提示辅导员错误，请认真检查辅导员名称，或联系网站管理员，班级一经创建，就无法删除！
						"
						>创建班级注意事项</a>
					</div>
					<br><br><br><br>
					...
					<div class="col-md-2"><span class="glyphicon glyphicon-save"></span><a href="<?php echo base_url("upload/demo.xls");?>">下载excel模板</a></div>
						</p>
					</div>
